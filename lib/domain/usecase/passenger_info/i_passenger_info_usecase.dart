...
import '../../../source/data/model/common/status_message_res.dart';
import '../../../source/data/model/passenger_info/stripe_invoice_res.dart';
import '../../../source/data/model/passenger_info/ticket_sale_prams.dart';
import '../../../source/data/model/passenger_info/ticket_sale_res.dart';

abstract class IPassengerInfoUseCase {
